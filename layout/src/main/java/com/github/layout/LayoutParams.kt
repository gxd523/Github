...
@set:TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
var <T : ViewGroup.MarginLayoutParams> T.startMargin: Int
    set(value) {
        marginStart = value
    }
    get() {
...
@get:TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
@set:TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
var <T : ViewGroup.MarginLayoutParams> T.endMargin: Int
    set(value) {
        marginEnd = value
    }
    get() {
...
fun <T : ViewGroup.MarginLayoutParams> T.margin(margin: Int) {
    leftMargin = margin
    topMargin = margin
    rightMargin = margin
    bottomMargin = margin
