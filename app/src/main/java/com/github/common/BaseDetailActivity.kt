...
// TODO: 1/6/21 unfinished：@ActivityBuilder(pendingTransition = PendingTransition(enterAnim = R.anim.rignt_in, exitAnim = R.anim.left_out))
...
// TODO: 1/6/21 unfinished：@ActivityBuilder(pendingTransition = PendingTransition(enterAnim = 0, exitAnim = 0))
