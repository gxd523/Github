...
public class FixLuRecyclerView extends RecyclerView {
    ...
    private final boolean flag = false;//标记是否setAdapter
    /**
     * 当前RecyclerView类型
     */
            ...
            if (adapter instanceof LRecyclerViewAdapter) {
                ...
                if (lRecyclerViewAdapter.getInnerAdapter() != null && mEmptyView != null) {
                    ...
                    if (count == 0) {
                        ...
                        com.github.jdsjlzx.recyclerview.FixLuRecyclerView.this.setVisibility(View.GONE);
                    } else {
                        mEmptyView.setVisibility(View.GONE);
                        com.github.jdsjlzx.recyclerview.FixLuRecyclerView.this.setVisibility(View.VISIBLE);
                    }
                }
            } else {
